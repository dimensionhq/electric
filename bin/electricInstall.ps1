...
Start-BitsTransfer 'https://srv-store6.gofile.io/download/ck3vDN/Electric%20v1.0.0%20Alpha%20Setup.exe' "${Env:\TEMP}\ElectricSetup.exe" -Description 'Downloading Electric Alpha v1.0.0 Setup from https://srv-store6.gofile.io/download' -DisplayName 'Downloading Electric' -TransferType Download
